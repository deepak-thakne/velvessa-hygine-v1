    ...
    <div className="landing-page">
      ...
      <nav className="navbar">
        <div className="logo-container">
          <img src="/images/velvessa_logo.png" alt="Velvessa Logo" className="logo-img" />
        </div>
      ...
      <header id="home" className="hero">
        ...
        >
          <img src="/images/softflow_logo.png" alt="SoftFlow" className="product-logo" />
      ...
      <section className="product-choice">
        <motion.div className="container" {...fadeInUp}>
          <div className="choice-card">
            ...
            {/* --- Anion Chip Benefits Infographic --- */}
        ...
        {showSuccess && (
          ...
          >
            ...
            >
              ...
              <button onClick={() => setShowSuccess(false)} className="close-success">Great</button>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
